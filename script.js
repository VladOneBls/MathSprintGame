...
function updateBestScore() {
  bestScoreArray.forEach((score, index) => {
    ...
    if (questionAmount == score.questions) {
      // Return Best Scoreas as number with one decimal
...
// Sart Timer when game page is clicked
function startTimer() {
  // Reset times
  timePlayed = 0;
  penaltyTime = 0;
...
function selectQuestionAmount(e) {
  e.preventDefault(); // avoid submitting the event to a server and refreshing the page
